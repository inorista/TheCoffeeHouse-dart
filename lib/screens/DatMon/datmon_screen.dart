...
class Bodybuild2 extends State<BodyDatMon> {
  ...
  Widget build(BuildContext context) {
    ...
    Future _scrollToIndex(int index) async {
      await controllers.scrollToIndex(index,
    ...
    void showBottomSheet(int index, int index2, currentPrice, soluong,
            fixedPrice, sltopping, toppingPrice) async =>
    ...
    return SingleChildScrollView(
                      ...
                      child: Container(
                          ...
                          child: Column(
                              ...
                              children: [
                                ...
                                ...List.generate(listmon[index].length,
                                    (index2) {
                                  return Slidable(
      ...
      Positioned(
          ...
          child: Container(
              ...
              width: width,
              padding:
                  EdgeInsets.only(top: 14, bottom: 10, left: 12, right: 12),
                  ...
                  children: [
                    ...
                    Opacity(
                        ...
                        child: Container(
                            ...
                            child: Text(
                                "518/2/18 Lê Văn Sỹ Phường 11, Quận Phú Nhuận, TPHCM",
                                overflow: TextOverflow.ellipsis,
                                style: TextStyle(
                                  fontSize: 14,
                                  color: Colors.black,
